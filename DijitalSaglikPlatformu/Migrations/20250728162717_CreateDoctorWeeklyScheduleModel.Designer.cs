...
namespace DijitalSaglikPlatformu.Migrations
{
    ...
    [Migration("20250728162717_CreateDoctorWeeklyScheduleModel")]
    partial class CreateDoctorWeeklyScheduleModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DijitalSaglikPlatformu.Models.DoctorWeeklySchedule", b =>
                {
                    b.HasOne("DijitalSaglikPlatformu.Models.DoctorProfile", "Doctor")
                        .WithOne("DoctorWeeklySchedule")
                        .HasForeignKey("DijitalSaglikPlatformu.Models.DoctorWeeklySchedule", "DoctorProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
