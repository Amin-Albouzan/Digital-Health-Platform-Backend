...
namespace DijitalSaglikPlatformu.Migrations
{
    ...
    [Migration("20251010073823_CreateDoctorReviewModel")]
    partial class CreateDoctorReviewModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DijitalSaglikPlatformu.Models.DoctorReview", b =>
                {
            ...
            modelBuilder.Entity("DijitalSaglikPlatformu.Models.DoctorWeeklySchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DijitalSaglikPlatformu.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DijitalSaglikPlatformu.Models.DoctorProfile", b =>
                {
                    b.HasOne("DijitalSaglikPlatformu.Models.AppUser", "AppUser")
                        ...
                        .HasForeignKey("DijitalSaglikPlatformu.Models.DoctorProfile", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DijitalSaglikPlatformu.Models.DoctorReview", b =>
                {
                    b.HasOne("DijitalSaglikPlatformu.Models.DoctorProfile", "DoctorProfile")
                        .WithMany()
                        .HasForeignKey("DoctorProfileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DijitalSaglikPlatformu.Models.RefreshToken", b =>
                {
                    b.HasOne("DijitalSaglikPlatformu.Models.AppUser", "User")
